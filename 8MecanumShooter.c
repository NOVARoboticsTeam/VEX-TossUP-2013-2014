...
#pragma config(Motor,  port1,           leftRear,      tmotorVex393, openLoop, encoder, encoderPort, I2C_2, 1000)
#pragma config(Motor,  port2,           leftFront,     tmotorVex393, openLoop, encoder, encoderPort, I2C_3, 1000)
#pragma config(Motor,  port3,           topShooter,    tmotorVex393, openLoop)
#pragma config(Motor,  port4,           bottomShooter, tmotorVex393, openLoop, reversed)
...
#pragma config(Motor,  port7,           intake,        tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port8,           flap,          tmotorVex393, openLoop)
#pragma config(Motor,  port9,           rightFront,    tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_4, 1000)
#pragma config(Motor,  port10,          rightRear,     tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_1, 1000)
